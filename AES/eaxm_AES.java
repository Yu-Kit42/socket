...
public class eaxm_AES {
    ...
    public static void setIvSpec(IvParameterSpec ivSpec) {
        eaxm_AES.ivSpec = ivSpec;
    }
    public static void setKeySpec(Key keySpec) {
        eaxm_AES.keySpec = keySpec;
    }
    public static void main(String[] args) throws Exception {
        ...
        new eaxm_AES().decrypt(new File("C:/test/100-Sales-RecordsEncrypted.enc"), new File("C:/test/100-Sales-RecordsDecrypted.zip"));
